...
export interface TileCollectionStateFormatObject{
  statesUsed: StatesUsed;
  state: State;
}

export class TileSettings implements TileCollectionStateFormatObject{
  ...
  export class TextSettings implements TileCollectionStateFormatObject{
    public state: State = State.all
    public statesUsed: StatesUsed = {
      selected: true,
      unselected: true,
  ...
  export class EffectSettings implements TileCollectionStateFormatObject{
    public state: State = State.all
    public statesUsed: StatesUsed = {
      selected: true,
      unselected: true,
  ...
  export class IconSettings implements TileCollectionStateFormatObject{
